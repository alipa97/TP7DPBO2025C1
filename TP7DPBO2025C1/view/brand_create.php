...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $brand->createBrand($_POST['name'], $_POST['country']);
    header("Location: index.php?page=brands");
    exit;
}
?>

<h3 class="w-full py-4 text-center text-xl text-sky-900">Create Brand</h3>
...
<form method="POST" class="max-w-md mx-auto space-y-4">
    ...
    <div>
        ...
        <input type="text" name="country" required class="w-full border border-gray-300 rounded-lg px-4 py-2">
    </div>
